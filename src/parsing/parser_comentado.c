...
/*   Updated: 2025/01/28 19:43:42 by ggroff-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 				atl_cmd->args, atl_cmd->argument_count + 1, tokens->value); //adiciona o novo comando (tokens->value) a listá de argumentos atl_cmd->args
